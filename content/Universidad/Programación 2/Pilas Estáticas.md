...
typedef ... tItemS; //tipo de elemento
typedef int tPosS;  //tipo de posición

// Para lista estática:
typedef struct {
    tItemS data[MAX]; //Array donde se almacena la información
    tPosS top;    //Última posición que almacena información útil
} tStack;
```
